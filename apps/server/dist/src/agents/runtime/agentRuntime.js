...
var AgentRuntime = /** @class */ (function () {
    function AgentRuntime(executorFactory) {
        if (executorFactory === void 0) { executorFactory = agentExecutorFactory_1.agentExecutorFactory; }
        this.executorFactory = executorFactory;
    }
    AgentRuntime.prototype.execute = function (input) {
        return __asyncGenerator(this, arguments, function execute_1() {
            var executor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        executor = this.executorFactory.create(input.agent.backend);
                        return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(executor.execute(input))))];
