...
export class ToolRuntime {
  constructor(private readonly timeoutMs = configuredTimeout(), private readonly allowSideEffects = process.env.TOOL_ALLOW_SIDE_EFFECTS === "true", private readonly executors: Pick<ToolExecutorFactory, "create"> = toolExecutorFactory) {}
